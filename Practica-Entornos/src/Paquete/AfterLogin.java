...
public class AfterLogin extends JFrame {
	...
	/**
	 * Crear el segundo frame que esta conectado con el JPanel Login.
	 */
	public AfterLogin() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AfterLogin.class.getResource("/Paquete/logo.jpg")));
		setTitle("Juanxxiii");
		...
		/**
		 * Crear un Jlabel que es la caja de Felicidades
		 */
		...
		/**
		 * Aniadimos un JMenu a la bara de menu para informar el usuario donde esta(Tu Cuenta).
		 */
		...
		/**
		 * Aniadimos otro JLabel para escribir el mensaje informativo para el usuario
		 */
		...
		/**
		 * Crear el buton que permite volver a la pagina de inicio
		 */
